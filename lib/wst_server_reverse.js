...
var WebSocketServer, bindSockets, http, net, url, wst_server_reverse, portsInUse;
  ...
  this.wsServerForControll.on('request', (function(_this){
    return function(request){
      ...
      if (uri.query.dst != undefined){
        ...
        if (portTcp in portsInUse) {
            console.log("Duplicate TCP port "+portTcp);
            request.reject();
        } else {
            portsInUse[portTcp] = true;
